...
We are providing here with the python code which is part of the ManifoldEM python sofrware, since it contains a cleaner and updated version of the original Matlab implementation.
